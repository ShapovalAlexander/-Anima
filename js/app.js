(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".ideas__slider")) new swiper_core_Swiper(".ideas__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".ideas__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".ideas__arrow--prev",
                nextEl: ".ideas__arrow--next"
            },
            on: {}
        });
    }
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("top-header__search")) document.querySelector(".search-form").classList.toggle("_active"); else if (!targetElement.closest(".search-form") && document.querySelector(".search-form._active")) document.querySelector(".search-form").classList.remove("_active");
        }
    };
    window["FLS"] = true;
    isWebp();
